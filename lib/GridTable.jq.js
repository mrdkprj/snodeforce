...
class GridTable {
	...
	createGridTable(){
		...
		const getColumnHeader = () => {
			...
			//columnHeader.on("mousemove", this.moveSlidebar.bind(this));
		...
		this.inputHolder = $("<div style='position:fixed;top:-100px;left:-100px;z-index:200;'>")
		this.editor = $("<textarea class='cell-editor' spellcheck='false' style='z-index:201;'/>");
	...
	createRow(rowIndex){
		...
		const rowHeaderCell = $("<div>", { class: "gtbl-header-cell gtbl-row-header-cell", css:{"transform": "translate3D(0px, 0px, 0px)"}, text: rowIndex + 1 });
	...
	initEditor(){
		...
		this.inputHolder.css({top: -100, left: -100});
	}
