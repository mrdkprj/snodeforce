	...
	return class GridTable {
		...
		scrollX(target){
			...
			if(scrollLeft >= position.left){
				...
				this.rootElement.scrollLeft(position.left);
				return true;
			}

			if(scrollLeft + position.left + target.width() >= this.rootElement.width()){
			//if(scrollLeft + this.rootElement.width() <= position.top + pad + target.outerHeight(true) + this.barHeight){
		...
		scrollY(target, padding){
			...
			if(scrollTop + this.visibleViewportHeight <= position.top + pad + target.outerHeight(true) + this.barHeight){
				by = (position.top + target.outerHeight(true)) - (scrollTop + this.visibleViewportHeight) + this.barHeight;
